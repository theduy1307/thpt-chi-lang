...
import { NgbDateAdapter, NgbDateParserFormatter, NgbDatepickerModule, NgbDropdownModule, NgbModalModule } from "@ng-bootstrap/ng-bootstrap";
...
import { QuanLiTaiKhoanHocSinhUpdateComponent } from "./quan-li-tai-khoan-hoc-sinh/quan-li-tai-khoan-hoc-sinh-update/quan-li-tai-khoan-hoc-sinh-update.component";
...
@NgModule({
  declarations: [
    ...
    QuanLiTaiKhoanCreateComponent,
    QuanLiTaiKhoanDetailComponent,
    QuanLiMonHocCreateComponent,
    QuanLiTaiKhoanEditComponent,
    QuanLiNienKhoaAddComponent,
    QuanLiNienKhoaEditComponent,
    QuanLiNienKhoaComponent,
    QuanLiLopComponent,
    QuanLiNienKhoaAddComponent,
    QuanLiLopAddComponent,
    QuanLiLopEditComponent,
    QuanLiMonHocEditComponent,
    DanhSachChuongMonHocComponent,
    ChinhSuaChuongMonHocComponent,
    DanhSachBaiHocModifyComponent,
    ThemMoiChuongMonHocComponent,
    QuanLiTaiKhoanHocSinhComponent,
    QuanLiTaiKhoanHocSinhCreateComponent,
    QuanLiTaiKhoanHocSinhImportComponent,
    QuanLiTaiKhoanHocSinhUpdateComponent,
  ],
  imports: [
    CommonModule,
    HttpClientModule,
