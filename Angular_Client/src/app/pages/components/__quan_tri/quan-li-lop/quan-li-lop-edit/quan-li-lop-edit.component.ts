...
@Component({
  selector: 'app-quan-li-lop-edit',
  templateUrl: './quan-li-lop-edit.component.html',
  styles: [
  ]
})
export class QuanLiLopEditComponent implements OnInit {
  /* ------------------------ Inject Event Data -----------------------*/
  @Input() id: number
  /* ------------------------------------------------------------------*/
  ...
  loadForm() {
    this.formGroup = this.fb.group({
      TenLop: [this.data.TenLop, Validators.compose([Validators.required])],
      IdNienKhoa: [this.data.IdNienKhoa],
      TenNienKhoa: [this.data.IdNienKhoa+'', Validators.compose([Validators.required])],
      IdChuNhiem: [this.data.IdChuNhiem],
      TenChuNhiem: [this.data.IdChuNhiem+'', Validators.compose([Validators.required])],
