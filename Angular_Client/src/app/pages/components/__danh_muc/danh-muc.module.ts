...
import { BaiKiemTraCreateExamComponent } from './bai-kiem-tra/bai-kiem-tra-create-exam/bai-kiem-tra-create-exam.component';
...
@NgModule({
  declarations: [
    ...
    BaiKiemTraCreateExamComponent,
    BaiKiemTraEditExamComponent,
  ],
  imports: [
    CommonModule,
    HttpClientModule,
